...
for k=imstart:imend
    ...
    [Crest1,lamda1, innerdistvec1,outerdistvec1] = CrestFinderv2(image1,centers,minradius);
    drawnow
    ...
    [Crest2,lamda2, innerdistvec2,outerdistvec2] = CrestFinderv2(image1,centers,minradius);
...
lamdavec=reshape(lamdavec,[],1);
%%
phasevec=nonzeros(phasevec);
lamdavec=nonzeros(lamdavec);
%%
[phasevec PI]=sort(phasevec,'descend');
[lamdavec LI]=sort(lamdavec);
